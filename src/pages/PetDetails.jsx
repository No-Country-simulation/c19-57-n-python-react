      ...
      <div className="mx-auto lg:max-w-[1216px]" id="PetDetails">
        ...
        <div className="shadow-[0px_7px_25px_-9px_#00000040] rounded-2xl md:flex md:mb-[43px] items-center">
          <div className="overflow-hidden rounded-b-2xl mb-[34px] md:mb-0 md:w-1/2">
            <img className="m-auto" src={`${IMG_FOLDER_URL}/perfil/${pet.imagen_profile}`} alt="Pet image" />
          </div>
          <div className="capitalize flex w-full px-[20px] pb-5 mb-6 md:mb-0 md:flex-col md:w-1/2 md:pr-[50px]">
            <div className="md:space-y-3 md:ml-[29px] md:mb-[25px] flex place-content-between w-full md:block">
              <p className="font-semibold flex flex-col items-center text-[14px] md:text-[20px] gap-1 md:flex-row md:font-normal">
                <img className="md:inline mr-2" src="/gender.svg" alt="Gender Icon" />
                <span className="md:font-semibold uppercase text-[10px] md:text-xl">Sexo<span className="hidden md:inline">:</span> </span>
                {pet.gender}
              </p>
              <p className="font-semibold flex flex-col items-center text-[14px] md:text-[20px] gap-1 md:flex-row md:font-normal">
              ...
              <p className="font-semibold flex flex-col items-center text-[14px] md:text-[20px] gap-1 md:flex-row md:font-normal">
                ...
                <span className="md:font-semibold uppercase text-[10px] md:text-xl">Tamaño<span className="hidden md:inline">:</span> </span>
                {pet.size} cm
              </p>
              <p className="font-semibold flex flex-col items-center text-[14px] md:text-[20px] gap-1 md:flex-row md:font-normal">
                <img className="md:inline mr-2" src="/years.svg" alt="Years Icon" />
                <span className="md:font-semibold uppercase text-[10px] md:text-xl">Edad<span className="hidden md:inline">:</span> </span>
                {pet.year} años
              </p>
            </div>
            <button className="hidden md:block bg-pink-default font-semibold py-2 w-full rounded-2xl">Quiero adoptar</button>
          </div>
        </div>
